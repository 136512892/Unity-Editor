...
public interface IComponentGUIInspector
{
    void Draw(Component component);
}

public abstract class ComponentGUIInspector : IComponentGUIInspector
{
    ...
    protected void DrawText(float spaceWidth, string label, 
        string text, float labelWidth)
    {
        GUILayout.BeginHorizontal();
    ...
    protected bool DrawToggle(float spaceWidth, string label,
        bool value, float labelWith)
    {
        GUILayout.BeginHorizontal();
        GUILayout.Space(spaceWidth);
        GUILayout.Label(label, GUILayout.Width(labelWith));
    ...
    protected int DrawInt(string label, int value,
        float labelWith, params GUILayoutOption[] options)
    {
        GUILayout.BeginHorizontal();
        GUILayout.Label(label, GUILayout.Width(labelWith));
    ...
    protected int DrawInt(float spaceWidth, string label, 
        int value, float labelWith, params GUILayoutOption[] options)
    {
        GUILayout.BeginHorizontal();
        GUILayout.Space(spaceWidth);
        GUILayout.Label(label, GUILayout.Width(labelWith));
    ...
    protected float DrawFloat(string label, float value,
        float labelWith, params GUILayoutOption[] options)
    {
        GUILayout.BeginHorizontal();
        GUILayout.Label(label, GUILayout.Width(labelWith));
    ...
    protected float DrawFloat(float spaceWidth, string label, float value,
        float labelWith, params GUILayoutOption[] options)
    {
        GUILayout.BeginHorizontal();
        GUILayout.Space(spaceWidth);
    ...
    protected Vector2 DrawVector2(string label, Vector2 vector2, 
        float labelWidth, float perFieldWidth)
    {
        GUILayout.BeginHorizontal();
        GUILayout.Label(label, GUILayout.Width(labelWidth));
    ...
    protected Vector2 DrawVector2(string label, 
        Vector2 vector2, float labelWidth, string x, 
        string y, float xyWidth, float perFieldWidth)
    {
        GUILayout.BeginHorizontal();
        GUILayout.Label(label, GUILayout.Width(labelWidth));
    ...
    protected Vector2 DrawVector2(float spaceWidth, string label,
        Vector2 vector2, float labelWidth, float perFieldWidth)
    {
        GUILayout.BeginHorizontal();
        GUILayout.Space(spaceWidth);
        GUILayout.Label(label, GUILayout.Width(labelWidth));
    ...
    protected Vector3 DrawVector3(string label, Vector3 vector3,
        float labelWidth, float perFieldWidth)
    {
        GUILayout.BeginHorizontal();
        GUILayout.Label(label, GUILayout.Width(labelWidth));
    ...
    protected float DrawHorizontalSlider(string label, 
        float value, float leftValue,float rightValue,
        float labelWidth, float valueLabelWidth)
    {
        GUILayout.BeginHorizontal();
        GUILayout.Label(label, GUILayout.Width(labelWidth));
    ...
    protected float DrawHorizontalSlider(float spaceWidth, 
        string label, float value, float leftValue, float rightValue,
        float labelWidth, float valueLabelWidth)
    {
        GUILayout.BeginHorizontal();
        GUILayout.Space(spaceWidth);
